...
(1, 'logo jadi 2.png', '<p>KAMI BIRO PERJALANAN WISATA PROFESIONAL " CAKRA TOUR PRO" DI MALANG MEMBERIKAN PELAYANAN PROFESIONAL DI BIDANG JASA PARIWISATA.</p>\n<ol>\n<li>MELAYANI RENTAL MOBIL ( RENT CAR) </li>\n<li>MELAYANI PAKET TOUR DOMESTIK <br /><ol style="list-style-type: lower-alpha;">\n<li>Bali </li>\n<li>Lombok </li>\n<li>Manado - Bunaken </li>\n<li>Karimun Jawa </li>\n<li>Jakarta - Bandung - Jogja </li>\n<li>Jakarta - Jogja </li>\n<li>Bromo - Malang - Batu - Taman Safari Indonesia II </li>\n<li>Malang - Pulau Sempu </li>\n<li>Bromo Adventure - Coban Pelangi </li>\n<li>Paket Studi Excursi ( Mahasiswa) , Sinau Wisata ( SD, SMP) </li>\n</ol></li>\n<li>MELAYANI PAKET TOUR ASIA: Singapore, Malaysia, Thailand, Hongkong, China.</li>\n</ol>\n<p>Hubungi Marketing kami :</p>\n<p>Arlinda Ningsih ( Nining) HP. 085755250302 ( IM3) , 081233890906 ( Simpati) Pin BB: 2A9D7E00 Percayakan Liburan Anda dengan Nyaman kepada kami, kami profesional dengan sepenuh hati melayani.</p>', 1, 'Tentang Cakra Tour Pro', '<p>KAMI BIRO PERJALANAN WISATA PROFESIONAL " CAKRA TOUR PRO" DI MALANG MEMBERIKAN PELAYANAN PROFESIONAL DI BIDANG JASA PARIWISATA. 1. MELAYANI RENTAL MOBIL ( RENT CAR) 2. MELAYANI PAKET TOUR DOMESTIK<', 'Cakra TOur Pro, Wisata Tour, Lombok, Bali, Jawa Timur');
...
(1, '-7.9435543', '112.6279327', '<h5>JL.Danau maninjau selatan Blok D7 No.27, sawojajar, Sawojajar, Kedungkandang, Kota Malang, Jawa Timur 65142</h5>\r\n<p>0812-1324-6452</p>', '', '', '', '');
