     ...
     <div class="row">
       <div class="col-sm-12">
        <div class="welcome__content">
         <h1 class="welcome_content__title">Paket Wisata</h1>
 ...
 <div class="container">
   ...
   <div class="footer__item">
    <div class="blog-item__link">
      <a href="<?=site_url('home/tampil_blog_item');?>">/ Read More /</a>
    </div> <!-- .blog-item__link -->
  </div> <!-- .footer__item -->
  <div class="footer__item">
...
<div class="blog__item">
 <div class="blog-item__img">
  <img src="<?php echo base_url().'assets/' ?>images/events_img6.jpg" class="img-responsive" alt="...">
</div>
<div class="blog-item__content">
 <div class="blog-item__category">
