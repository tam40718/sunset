	...
	<div class="container">
		<div class="footer__body">
			<div class="row">
				<div class="col-xs-12 col-sm-4 col-sm-push-4 col-md-6 col-md-push-3">
				  ...
				  <!-- <div class="col-xs-2 col-sm-1 col-sm-pull-1 col-md-1 col-md-pull-7">
		  		  	<div class="footer__item">
		  					<ul class="footer__links">
			  					<li><a href="index-slider.html">Home</a></li>
								<li><a href="about.html">About Us</a></li>
								<li><a href="room-1.html">Room</a></li>
								<li><a href="room-2.html">Facilities</a></li>
		...
		<div class="footer__copyright">
			<div class="row">
				<div class="col-xs-12">
					<hr>
					<p class="footer_copyright__text">&#169; 2018 Sunset Grand Hotel. All rights reserved.</p>
				</div>
			</div> <!-- / .row -->	
