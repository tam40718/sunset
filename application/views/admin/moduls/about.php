...
<div class="tabbable">
	...
	<form action="#" id="form" name="form" class="form-horizontal" enctype="multipart/form-data">
		...
		<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> Judul </label>
			<div class="col-sm-10">
				<input type="text" id="about_judul" name="about_judul" placeholder="Judul" class="col-xs-10 col-sm-5" />
		...
		<div class="form-group">
		<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> Deskripsi ke 2 </label>
			<div class="col-sm-6">
				<textarea class="form-control" id="about_deskripsi2" name="about_deskripsi2" placeholder="Deskripsi ke 2" ></textarea>
				<span class="help-block"></span>
			</div>
		</div>
		<div class="form-group">
	...
	<form id="form-upload" class="form-horizontal" role="form" action="<?= site_url('About/upload')?>" method="POST" enctype="multipart/form-data">
		...
		<div class="form-body">
			<div class="form-group" >
			<label class="control-label col-md-3">Pilih File Gambar</label>
	...
	<form id="form-upload2" class="form-horizontal" role="form" action="<?= site_url('About/upload_video')?>" method="POST" enctype="multipart/form-data">
		<input type="hidden" name="id_about"/> 
		<div class="form-body">
			<div class="form-group" >
			<label class="control-label col-md-3">Pilih File Cover Video</label>
			<div class="input-group col-md-6">
				<input type="file" name="file-upload" id="file-upload2">
				<span class="help-block"></span>
				<div class="input-group-btn">
					<button type="submit" class="btn btn-primary">Upload</button>
				</div>
			...
			<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> Link Video </label>
				<div class="col-sm-10">
					<input type="text" id="about_video" name="about_video" placeholder="Link Video" class="col-xs-10 col-sm-5" required />
					<span class="help-block"></span>
				</div>
			</div>
		</div>
...
<script>
	...
	function update() {
			...
			$.ajax({
				...
				var img = '<?= base_url(); ?>assets/images/about/'+result.about_logo;
				var img2 = '<?= base_url(); ?>assets/images/about/'+result.about_cover;
				$('[name="id_about"]').val(result.id_about);
				$('[name="about_judul"]').val(result.about_judul);
				$('[name="about_deskripsi"]').val(result.about_deskripsi);
				$('[name="about_deskripsi2"]').val(result.about_deskripsi2);
