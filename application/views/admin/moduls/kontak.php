...
<form class="form-horizontal" role="form" id="formAksi">
	...
	<div class="form-group">
	<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> Kontak Subheading </label>
		<div class="col-sm-10">
			<input type="text" id="kontak_subheading" name="kontak_subheading" placeholder="Kontak Subheading" class="col-xs-10 col-sm-5" />
		</div>
	</div>
	<div class="form-group">
	...
	<div class="form-group">
	<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> Kontak Alamat </label>
		<div class="col-sm-6">
			<textarea class="form-control" id="kontak_alamat" name="kontak_alamat" placeholder="Kontak Alamat" class="col-xs-10 col-sm-5" required></textarea>
		</div>
	</div>
	<div class="form-group">
	<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> Kontak Telepon </label>
		<div class="col-sm-10">
			<input type="text" id="kontak_telepon" name="kontak_telepon" placeholder="Kontak Telepon" class="col-xs-10 col-sm-5" required maxlength="12" />
		</div>
	</div>
	<div class="form-group">
	<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> Kontak Email </label>
		<div class="col-sm-10">
			<input type="email" id="kontak_email" name="kontak_email" placeholder="Kontak Email" class="col-xs-10 col-sm-5" required />
		</div>
	</div>
	<div class="form-group">
	...
	function edit() {
			...
			$.ajax({
				...
				success: function(result) {  
					...
					$('[name="kontak_alamat"]').val(result.kontak_alamat);
					$('[name="kontak_telepon"]').val(result.kontak_telepon);
					$('[name="kontak_email"]').val(result.kontak_email);
					$('[name="kontak_judul"]').val(result.kontak_judul);
					$('[name="kontak_subheading"]').val(result.kontak_subheading);
