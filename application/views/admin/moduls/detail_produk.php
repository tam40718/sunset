<?php $title = "<i class='fa fa-briefcase'></i>&nbsp;Detail Produk"; ?>
...
<form id="form-add" class="form-horizontal" action="<?= site_url('produk/ajax_addproduk')?>" method="POST" role="form" enctype="multipart/form-data">
	...
	<input type="hidden" name="id_produk" value="<?php echo $key;?>">
...
<div class="tabbable">
	...
	<div class="tab-content">
		<div id="home" class="tab-pane fade in active">
			...
			<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> Deskripsi </label>
				<div class="col-sm-6">
					<textarea class="form-control" id="teksarea" name="detail_deskripsi" placeholder="Deskripsi" class="col-xs-10 col-sm-5" cols="30" rows="10"></textarea>
					<span class="help-block"></span>
				</div>
			</div>
			<div class="form-group">
			...
			<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> Detail Deskripsi Meta </label>
				<div class="col-sm-6">
					<textarea class="form-control" id="teks" name="detail_deskripsi_meta" placeholder="Deskripsi" class="col-xs-10 col-sm-5" cols="30" rows="10"></textarea>
					<span class="help-block"></span>
				</div><br /><br /><br /><br />
				<div class="col-md-offset-2 col-md-9">
...
<script>
	...
	function edit(id) {
			...
			$.ajax({
				...
				tinymce.editors[2].setContent(result.detail_deskripsi);
				...
				tinymce.editors[3].setContent(result.detail_deskripsi_meta);
	...
	function hapuse(id) {
		if (confirm('Are you sure delete this data?')) {
			$.ajax ({
				url : "<?php echo site_url('produk/ajax_delproduk')?>/"+id,
				type: "POST",
				dataType: "JSON",
				success: function(data) {
					setTimeout(function(){
