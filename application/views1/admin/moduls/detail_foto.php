...
<form id="form-add" class="form-horizontal" action="<?= site_url('gallery/ajax_addfoto')?>" method="POST" role="form" enctype="multipart/form-data">
	...
	<input type="hidden" name="id_album" value="<?php echo $key;?>">
...
<div class="tabbable">
	...
	<div class="tab-content">
		<div id="home" class="tab-pane fade in active">
			...
			<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> Gallery Deskripsi Meta </label>
				<div class="col-sm-6">
					<textarea class="form-control" id="teksarea" name="gallery_deskripsi_meta" placeholder="Gallery Deskripsi Meta" class="col-xs-10 col-sm-5"></textarea>
					<span class="help-block"></span>
				</div><br /><br /><br /><br />
				<div class="col-md-offset-2 col-md-9">
...
<script type="text/javascript">
	...
	function edite(id) {
			...
			$.ajax({
				...
				tinymce.editors[1].setContent(result.gallery_deskripsi_meta);
